...
export function DosenSidebar({ isVisible, onClose }: SidebarProps) {
    ...
    >
      ...
      >
        ...
        <View style={styles.sectionLabelContainer}>
           <ThemedText style={styles.sectionLabel}>MENU DOSEN</ThemedText>
        </View>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          <SidebarItem 
            icon="grid-outline" 
            label="Dashboard" 
            onPress={() => { onClose(); router.push('/dashboard-dosen'); }}
          />
          <SidebarItem 
            icon="calendar-outline" 
            label="Jadwal Saya" 
            onPress={() => { onClose(); router.push('/dashboard-dosen/jadwal'); }}
          />
          <SidebarItem 
            icon="time-outline" 
            label="Riwayat Presensi" 
            onPress={() => { onClose(); router.push('/dashboard-dosen/history'); }}
          />
          <SidebarItem 
            icon="person-outline" 
            label="Profil" 
            onPress={() => { onClose(); router.push('/dashboard-dosen/profile'); }}
          />

          <View style={styles.divider} />
          
          <View style={styles.sectionLabelContainer}>
             <ThemedText style={styles.sectionLabel}>SISTEM</ThemedText>
          </View>
